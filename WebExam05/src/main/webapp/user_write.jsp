...
<body>
	...
	<form name="joinForm" method="post" action="user_write_ok.jsp">
	<table>
		<tr>
		...
		<tr>
			<td>비밀번호</td>
			<td><input type="password" name="pass" id="pass" onKeyPress="passChk1()"></td>
		</tr>
		<tr>
			<td>비밀번호확인</td>
			<td><input type="password" name="repass" id="repass" onFocusOut="passChk2()"></td>
		</tr>
		<tr>
			<td>성별</td>
			<td>
		...
		<tr>
			...
			<td>
				...
				<select name="emailchk" onchange="emailChange()">
					<option>직접입력</option>
