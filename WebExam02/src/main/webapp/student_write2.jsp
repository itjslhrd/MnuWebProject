...
<body>
	<form name="student" method="post" action="student_write2_ok.jsp">
		<table>
			<tr>
				<td colspan="2" class="title">학생등록 2</td>
			</tr>
			<tr>
				<td>학년</th>
			...
			<tr>
				<td>성별</td>
				<td>
					<input type="radio" name="sgender" value="m">남성
					<input type="radio" name="sgender" value="w">여성
				</td>
			</tr>
			<tr>
				<td>전화번호</td>
				<td><input type="text" name="stel1" size="3">-
					<input type="text" name="stel2" size="3">-
					<input type="text" name="stel3" size="3">
				</td>
			</tr>
			<tr>
