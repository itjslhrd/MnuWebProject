  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      <tr>
        ...
        <img src="/BoardPhoto/img/bullet-01.gif"> <b>포 토 자 유 게 시 판</b></font></td></tr>
      <tr>
        <td colspan="5" align="right" valign="middle" height="20">
		<font size="2" face="고딕">전체 : <b>${counter}</b>건 - 1/ 2 Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
		...
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="board_view.do?idx=${dto.idx}">${dto.subject}</a></td>
					...
					<a class="list" href="mailto:ein1027@nate.com">${dto.name}</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2">${dto.regdate}</font></td>
				...
				<table>
					...
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="javascript:board_search()"><img src="/BoardPhoto/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
			<td width="25%" align="right">
			<a href="board_write.do"><img src="/BoardPhoto/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
