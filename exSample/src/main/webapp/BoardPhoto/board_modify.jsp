...
<script>
	...
	function pboard_send(){
		...
		if(pboard.contents.value==""){
			alert("내용을 입력하세요");
			pboard.contents.focus();
			return;
		}
		if(pboard.pass.value==""){
			alert("비밀번호를 입력하세요");
			pboard.pass.focus();
			return;
		}
	  ...
	  <table border="0">
	   ...
	   <tr>
		...
		<tr>
          ...
          <td>
             <a href="javascript:pboard_send()"><img src="/BoardPhoto/img/save.gif" border=0></a>&nbsp;&nbsp;&nbsp;
             <a href="javascript:history.back()"><img src="/BoardPhoto/img/cancle.gif" border=0></a>
          </td>
        </tr>
      </table>
      </form>
