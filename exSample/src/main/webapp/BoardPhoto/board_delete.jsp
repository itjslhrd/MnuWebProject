...
<head><title>방명록 삭제</title>
 ...
 <body>
 <form name="board" method="post" action="board_delete.do" >
 <input type="hidden" name="idx" value="${idx}">
   <table border="0" cellpadding="0" cellspacing="0" width="300" align="center">
     <tr>
       <td height="50">
       <img src="/BoardPhoto/img/bullet-05.gif"><b><font size="3" color="red">잠깐 !!</font></b></td></tr>
     <tr>
     ...
     <tr>
       ...
       <input type="button" value="삭제" onClick="board_send()">
