			...
			<table width="80%" border="0" cellspacing="0" cellpadding="0">
                ...
                <c:forEach var="userDTO" items="${userList}">      
                      <tr>
                        ...
                        <td bgcolor="#FFFFFF">${userDTO.name}</td>
                        <td align="center" bgcolor="#FFFFFF">${userDTO.userid}</td>
						<td align="center" bgcolor="#FFFFFF">${userDTO.email}</td>
						<td align="center" bgcolor="#FFFFFF">${userDTO.tel}</td>
						<td align="center" bgcolor="#FFFFFF">${userDTO.first_time}</td>
						<td align="center" bgcolor="#FFFFFF">${userDTO.last_time}</td>
                      </tr>
               </c:forEach>       
	                  <tr>
                        <td height="35" colspan="10" align="center" bgcolor="#FFFFFF"></td>
                      </tr>
						<form action="user" method="post" name="/Admin?cmd=user_list">
                      <tr>
